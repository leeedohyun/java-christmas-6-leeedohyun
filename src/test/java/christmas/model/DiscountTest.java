...
class DiscountTest {
    ...
    public void 디데이_할인_금액_계산_적용되는_경우_테스트() {
        ...
        final Price discountPrice = dDay.discount(visitedDay, totalPrice, orderDetail);
    ...
    public void 평일_할인_테스트() {
        ...
        final Price discountPrice = weekDay.discount(visitedDay, totalPrice, orderDetail);
    ...
    public void 주말_할인_금액_테스트() {
        ...
        final Price discountPrice = weekend.discount(visitedDay, totalPrice, orderDetail);
    ...
    public void 특별_할인_테스트() {
        ...
        final Price discountPrice = special.discount(visitedDay, totalPrice, orderDetail);
